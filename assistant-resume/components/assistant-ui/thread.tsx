    ...
    <div className="aui-thread-welcome-root mx-auto my-auto flex w-full max-w-[var(--thread-max-width)] flex-grow flex-col">
      <div className="aui-thread-welcome-center flex w-full flex-grow flex-col items-center justify-center">
        <div className="aui-thread-welcome-message flex size-full flex-col justify-center px-8">
          ...
          >
            What would you like to know about Alexander Lin?
          </m.div>
        </div>
      </div>
      <ThreadSuggestions />
...
const ThreadSuggestions: FC = () => {
  return (
    <div className="aui-thread-welcome-suggestions grid w-full gap-2 pb-4 @md:grid-cols-2">
      {[
        {
          title: "Who is Alexander?",
          label: "as a software engineer",
          action: "Who is Alexander Lin as a software engineer?",
        },
        {
          title: "What has Alexander built",
          label: "that has impacted users?",
          action: "What has Alexander Lin built that has impacted users?",
        },
        {
          title: "What is Alexander into",
          label: "outside of work?",
          action: "What is Alexander Lin into outside of work?",
        },
        {
          title: "How does Alexander think",
          label: "and approach problems?",
          action: "How does Alexander Lin think and approach problems?",
        },
